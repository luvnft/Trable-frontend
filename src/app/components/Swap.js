...
export default function Swap(){
    ...
    <div className="px-6 py-4">
        ...
        <div className="flex justify-between items-center mb-4"><div className="text-gray-700 text-sm mb-4">Receive</div>
        <div className="flex items-center">
    ...
    <button
            className="w-full bg-pink-500 text-white py-2 rounded hover:bg-pink-600 focus:outline-none mb-4">Confirm</button>
    </div>
</div></>)
}